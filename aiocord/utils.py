...
_eventful_intents = {
    ...
    _events.CreateMessage                     : _enums.Intents.guild_messages | _enums.Intents.direct_messages,
    _events.UpdateMessage                     : _enums.Intents.guild_messages | _enums.Intents.direct_messages,
